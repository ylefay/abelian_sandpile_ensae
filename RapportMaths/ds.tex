...
\begin{abstract}
	...
	Sous la conjecture supportée par des tests numériques que les flux d'ordres $k$, $\Phi_k$ évoluent proportionnellement en $t^{(k-1)/2}$, nous faisons le lien entre ces flux et le temps de relaxation du système et nous conjecturons que le probabilité que le système ne soit pas relaxé à l'instant $t$, qu'on note $\mathds{P}(T\geq t)$, est proportionnelle à $1/\sqrt{t}$. 
